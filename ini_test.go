...
`))
		...
		Convey("with `AllowShortCircuit` 'ture'", func() {
			Convey("Load the first available config, ignore other config", func() {
...
`)
			...
			Convey("Load the available config after unavailable config", func() {
...
`)
			...
			Convey("Load none available config, err should be returned", func() {
